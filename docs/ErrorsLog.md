...
- **Issue**: The application was making two concurrent or redundant API calls to Groq, which increased token usage and latency. The prompt was consuming a high amount of tokens (e.g., 300+).
