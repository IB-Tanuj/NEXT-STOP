const steps = [
  ...
  },
  {
    ...
    desc: "See every transport option within your budget — from sleeper class trains and flights (with real-time prices) to driving your own personal vehicle with calculated fuel costs.",
  },
  {
    number: "06",
    emoji: "🤖",
    title: "Get Your AI Trip Plan",
    desc: "Our AI generates a personalized itinerary, adventure activity recommendations, festival alerts, stay suggestions and local food recommendations — all specific to your destination and budget.",
  },
  {
    number: "07",
    emoji: "💾",
    title: "Save & Share Your Trip",
    desc: "Save your AI-generated itinerary to your personal dashboard. View it anytime, search your friends' profiles, or make your trip public to share a direct link with your friends.",
  },
  {
    number: "08",
    emoji: "🔗",
